...
function EditNameAutomation() {
  ...
  <label className='fontRepeat text-white'>
    Name
   
  </label>
  <input type="text" name="name" className='form-control fontRepeat text-white'  value="Go To Sleep" style={{backgroundColor:"#3f3d3d" }}/>
...
<button className='btn btn-sm btn-primary' onClick={()=>navigate(`${routeNames.dashboard}${routeNames.editlightcongif}`)}>Next</button>
</div>
